    ...
    cards: [
      {
        ...
        specificSkills: [
          "Java (Spring Boot)",
          "Python (Flask, Django for APIs/microservices)",
          ...
          "Cloud Services (AWS, Azure for backend infrastructure)",
          "Docker & Kubernetes",
    ...
    cards: [
      {
        ...
        specificSkills: [
          "Java (Spring Boot)",
          "Python (Flask, Django para APIs/microservicios)",
          ...
          "Servicios Cloud (AWS, Azure para infraestructura backend)",
          "Docker y Kubernetes",
          "Liquibase (Migraciones de BD)",
          "Git y GitLab CI/CD",
          ".NET (Servicios Backend)",
        ],
        accentColor: "var(--color-accent-blue)",
      },
      {
        ...
        specificSkills: [
          ...
          "Diseño Responsivo y Principios UI/UX",
        ],
        accentColor: "var(--color-accent-pink)",
      },
    ],
